...
public class Map {
    ...
    public void render(){
        ...
        attributesBatch.draw(bottomBgTexture, 0, 0, Gdx.graphics.getWidth(), tiles[0][0].getY());
        attributesBatch.draw(topBgTexture, 0, tiles[nColumns - 1][0].getY() + tiles[0][0].getSize(), Gdx.graphics.getWidth(), tiles[0][0].getY());
